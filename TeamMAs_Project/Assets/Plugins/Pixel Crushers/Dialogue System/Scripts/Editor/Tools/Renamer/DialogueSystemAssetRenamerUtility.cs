...
namespace PixelCrushers.DialogueSystem
{
    ...
    public static class DialogueSystemAssetRenamerUtility
    {
        ...
        public static bool ProcessVariableInScene(string originalName, string replacementName)
        {
            var replace = !string.IsNullOrEmpty(replacementName);
            var found = false;
            foreach (var incrementOnDestroy in GameObject.FindObjectsByType<IncrementOnDestroy>(FindObjectsSortMode.None))
            {
        ...
        public static bool ProcessActorInScene(string originalName, string replacementName)
        {
            var replace = !string.IsNullOrEmpty(replacementName);
            var found = false;
            foreach (var dialogueActor in GameObject.FindObjectsByType<DialogueActor>(FindObjectsSortMode.None))
            {
        ...
        public static bool ProcessQuestInScene(string originalName, string replacementName)
        {
            var replace = !string.IsNullOrEmpty(replacementName);
            var found = false;
            foreach (var dialogueSystemTrigger in GameObject.FindObjectsByType<DialogueSystemTrigger>(FindObjectsSortMode.None))
            {
                found = FindQuestInDialogueSystemTrigger(dialogueSystemTrigger, originalName, replacementName, replace, false) || found;
            }
            foreach (var questStateListener in GameObject.FindObjectsByType<QuestStateListener>(FindObjectsSortMode.None))
            {
        ...
        public static bool ProcessConversationInScene(string originalTitle, string replacementTitle)
        {
            ...
            foreach (var conversationStarter in GameObject.FindObjectsByType<ConversationStarter>(FindObjectsSortMode.None))
            {
